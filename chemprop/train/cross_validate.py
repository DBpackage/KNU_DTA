...
def cross_validate(args: TrainArgs,
    ...
    ###############################################################################
    ###############################################################################
    tokenizer, sps_tokenizer, smiles_tokenizer, pbpe, dbpe = get_vocabs(args)
    if args.prot_cnn:
    ...
    #print("train/cross_vadidate.py : data ",data);input()
    ...
    for fold_num in range(args.num_folds):
        ...
        # Otherwise, train the models
            ...
            model_scores,Cindex = train_func(args, data, logger, tokenizer, sps_tokenizer, smiles_tokenizer, pbpe, dbpe)
