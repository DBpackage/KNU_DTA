...
def evaluate_predictions(preds: List[List[float]],
    ...
    #print("targets:",len(targets),targets); input()
    metric_to_func = {metric: get_metric_func(metric) for metric in metrics}
    #print("evaluate.py : metric_to_func : ", metric_to_func)
    ...
    #print("after valid_preds",len(valid_preds), valid_preds)
    #print("aftet valid_targets",len(valid_targets), valid_targets)
    ...
    #print("results:", len(results), results); input()
