...
SPACE = {
    ...
    'depth'                 : hp.quniform('depth', low=2, high=5, q=1),
    'dropout'               : hp.quniform('dropout', low=0.1, high=0.2, q=0.05),
    'transformer_d_model'   : hp.choice('transformer_d_model', [64, 128, 256, 512]),
    'transformer_d_ff'      : hp.choice('transformer_d_ff' , [512, 1024, 1536]),
    #'ffn_num_layers': hp.quniform('ffn_num_layers', low=1, high=3, q=1)
}
INT_KEYS = ['hidden_size', 'depth', 'transformer_d_model', 'transformer_d_ff']
