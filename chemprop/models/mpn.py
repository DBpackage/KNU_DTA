...
class MPNEncoder(nn.Module):
    ...
    def forward(self,
        ...
        a_message = nei_a_message.sum(dim=1)  # num_atoms x hidden # mean -> sum : chemprop original
        # a_message = nei_a_message.mean(dim=1) # perceiverCPI
...
class MPN(nn.Module):
    ...
    def forward(self,
        ...
        #print("encodings type :", type(encodings))
        #for sub_list in encodings:
        #    print(len(sub_list))
        ...
        #print("MPN(self.encoder) output size : " , output.size())
        #print("This output is mpnn_out")
        return output
