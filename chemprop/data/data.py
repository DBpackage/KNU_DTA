...
class MoleculeDatapoint:
    ...
    def __init__(self,
        ...
        :param sequences : A list of the amino acid strings for the proteins.
        :param sps : A list of the SPS sequences for the proteins.
...
class MoleculeDataset(Dataset):
    ...
    def sps(self, flatten: bool = False) -> Union[List[str], List[List[str]]]:
        """
        Returns a list containing the SMILES list associated with each :class:`MoleculeDatapoint`.
        ...
        """
        if flatten:
            return [sps for d in self._data for sps in d.sps]

        return [d.sps for d in self._data]
